...
def parse_arguments(argv):
    ...
    parser.add_argument('--pretrained_model', type=str,default = '/home/huyu/models/facenet/20180211-122649/model-20180211-122649.ckpt-9000',
        help='Load a pretrained model before training starts.')
    #default = '/home/huyu/models/facenet/20180209-114624/model-20180209-114624.ckpt-0',
    #default='/home/huyu/models/facenet/20180207-203905/model-20180207-203905.ckpt-21000',
    # default='modeltrained/20170512/model-20170512-110547.ckpt-250000',

    parser.add_argument('--max_nrof_epochs', type=int, default=100)
    ...
    parser.add_argument('--learning_rate_decay_factor', type=float,
        help='Learning rate decay factor.', default=1)
