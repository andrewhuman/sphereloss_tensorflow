...
def reduction_b(net):
    ...
    with tf.variable_scope('Branch_1'):
        ...
        tower_conv1_1 = slim.conv2d(tower_conv1, 256, 3, stride=1,
                                    padding='VALID', scope='Conv2d_1a_3x3')
    with tf.variable_scope('Branch_2'):
        tower_conv2 = slim.conv2d(net, 256, 1, scope='Conv2d_0a_1x1')
        tower_conv2_1 = slim.conv2d(tower_conv2, 256, 3,
                                    scope='Conv2d_0b_3x3')
        tower_conv2_2 = slim.conv2d(tower_conv2_1, 256, 3, stride=1,
                                    padding='VALID', scope='Conv2d_1a_3x3')
    ...
    with tf.variable_scope(scope, 'InceptionResnetV1', [inputs], reuse=reuse):
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                ...
                #15 * 15 * 64
                net = slim.conv2d(net,64,3,stride=2,padding='VALID',scope='conv_2_3x3')

                #7 * 7 * 96
                net = slim.conv2d(net,96,3,stride=2,padding='VALID',scope='conv_3_3x3')
