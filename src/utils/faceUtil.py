...
#excise
def get_image_andlabes(dataset):
    image_path =[]
    label = []

    for i in range(len(dataset)):
        image_path += dataset[i].image_paths
        label += [i] * len(dataset[i].image_paths)
...
def get_dataset(paths, has_class_directories=True):
    ...
    for path in paths.split(':'):
        ...
        for i in range(nrof_classes):
            ...
            #/casia/casia_maxpy_mtcnnalign_182_160/000001...000000089 ...
            class_name = classes[i]
            #facedir=c:User/User/datasets/casia/casia_maxpy_mtcnnalign_182_160/000001....
            facedir = os.path.join(path_exp, class_name)
            #image_paths=c:User/User/datasets/casia/casia_maxpy_mtcnnalign_182_160/0000.../....img list
            image_paths = get_image_paths(facedir)
            #class_name = 0000...,   image_paths = ....img  list
